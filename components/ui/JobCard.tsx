        ...
        <View style={tw`bg-[#3A3E41] rounded-xl p-4 mb-4`}>
            <View style={tw`flex-row justify-between items-start`}>
                <View style={tw`flex-row items-start gap-4`}>
                    <Image source={imageAssets.avater} style={tw`w-12 h-12 rounded-lg`} />
                    <View style={tw`w-60`}>
            ...
            <View style={tw`flex-row items-center gap-3 mt-4`}>
                <TouchableOpacity onPress={() => router.push(`/drawer/home/jobs`)} style={tw`bg-[#4593F5] py-2 px-4 rounded-full border border-white`}>
                    <Text style={tw`text-white font-bold text-xs`}>Apply Now</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => router.push(`/drawer/screens/JobDetails`)} style={tw`py-2 px-4 rounded-full border border-gray-500`}>
