        ...
        <View style={tw`flex-1 bg-[#0F0E13]`}>
            ...
            <ScrollView contentContainerStyle={tw`p-4`}>
                ...
                <View style={tw`items-center text-center mb-6`}>
                    <Image source={imageAssets.logo} style={tw`w-24 h-24 rounded-full mb-4`} />
                ...
                <View style={tw`flex-row justify-center items-center gap-4 mb-8`}>
                    <TouchableOpacity onPress={() => router.push("/drawer/screens/JobApply")} style={tw`bg-[#4593F5] py-2 px-6 rounded-full border border-white`}>
