        ...
        <View style={tw`bg-[#3A3E41]`}>
            <View style={tw`p-4 flex-row justify-between items-center`}>
                <View style={tw`flex-row items-center gap-3`}>
                    <Image source={require('../../assets/images/avater/avater4.png')} style={tw`w-14 h-14 rounded-full`} />
                    <View>
            ...
            <Image source={require('../../assets/images/postimg1.png')} style={tw`w-full h-80`} />
        ...
        <View style={tw`py-3 px-1`}>
            <View style={tw`flex-row justify-between items-start`}>
                <View style={tw`flex-row items-start gap-3`}>
                    <Image source={require('../../assets/images/avater/avater2.png')} style={tw`w-10 h-10 rounded-full`} />
                    <View>
